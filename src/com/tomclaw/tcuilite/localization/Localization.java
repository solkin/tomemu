package com.tomclaw.tcuilite.localization;
...
public class Localization {
     ...
     */
    private static final String _MESSAGES_BUNDLE = "/res/localization/string.properties";
    ...
    public static boolean initLocalizationSupport(String locale) {
        ...
        try {
            ...
            if ((locale != null) && (locale.length() > 1)) {
                ...
                locale = locale.replace('-', '_').substring(0, 2);
                // System.out.println(prefix+"_"+locale+suffix);
